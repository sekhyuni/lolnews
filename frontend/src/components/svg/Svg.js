...
export const AntiClockwise = () => {
    return (
        <S.Svg>
            <path d="M589,544.5l-195.4,99.2l-27.3-36.9l156.3-95.6V277.3H589V544.5z M544.5,54.6C298.5,54.6,99,254.1,99,500H10l133.7,133.7L277.2,500h-89c0-196.8,159.5-356.3,356.3-356.3c196.8,0,356.4,159.5,356.4,356.3c0,196.8-159.5,356.3-356.4,356.3c-73.8,0-142.4-22.5-199.3-60.9l-53.5,71.4c71.8,49.6,158.9,78.6,252.9,78.6C790.5,945.4,990,746,990,500C990,254,790.5,54.6,544.5,54.6z" />
        </S.Svg>
    );
};