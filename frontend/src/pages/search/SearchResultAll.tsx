        ...
        <S.LiOfArticleWrapper contentType="normal" key={document._id} id={document._id}>
            ...
            <ReactModal isOpen={modalOfArticleIsOpen[idx]} onRequestClose={(): void => {
                ...
                <S.DivOfModalWrapper>
                    ...
                    <S.DivOfModalPCLinkURL>출처 -&nbsp;<S.AOfPCLinkURL href={document._source.pcLinkUrl} target="_blank" rel="noopener noreferrer">{document._source.pcLinkUrl}</S.AOfPCLinkURL></S.DivOfModalPCLinkURL>
                </S.DivOfModalWrapper>
            </ReactModal>
