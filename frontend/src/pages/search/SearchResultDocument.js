...
const SearchResultDocument = ({ keyword, setKeyword }) => {
        ...
        <S.DivOfLayoutWrapper>
            <S.Header>
                <S.HeaderOfTop>
                    ...
                    <S.Div>
                        <Input layoutName="search" type="document" keyword={keyword} setKeyword={setKeyword} />
                    </S.Div>
                    <S.Nav>
                    </S.Nav>
                </S.HeaderOfTop>
                ...
                <S.Aside>
                    <S.AsideOfContent type={1}>
                        ...
                        <S.DivOfRelatedSearchTermWrapper>
                            <S.LinkOfRelatedSearchTerm to="/search/document?q=페이커">
                                페이커
                            </S.LinkOfRelatedSearchTerm>
                            <S.LinkOfRelatedSearchTerm to="/search/document?q=롤">
                                롤
                            </S.LinkOfRelatedSearchTerm>
                            <S.LinkOfRelatedSearchTerm to="/search/document?q=LOL">
                                LOL
                            </S.LinkOfRelatedSearchTerm>
                        </S.DivOfRelatedSearchTermWrapper>
                    </S.AsideOfContent>
